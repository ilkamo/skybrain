...
var skynetClient = new skynet_js_1.SkynetClient(portal);
...
var User = /** @class */ (function () {
  ...
  User.prototype.Login = function (passphrase) {
    return __awaiter(this, void 0, Promise, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            (_a = skynet_js_1.keyPairFromSeed(passphrase)),
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              skynetClient.db.getJSON(publicKey, userDataKey),
            ];
          case 2:
            data = _b.sent().data;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              skynetClient.db.setJSON(this.privateKey, userDataKey, {
                nickname: nickname,
              }),
            ];
          case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              skynetClient.db.getJSON(this.publicKey, userImagesDataKey),
            ];
          case 1:
            data = _a.sent().data;
            if (data) {
  ...
  User.prototype.DeleteImage = function (skylink) {
    return __awaiter(this, void 0, Promise, function () {
      var images, foundIndex, error_5;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 4, , 5]);
          ...
          case 1:
            images = _a.sent();
            foundIndex = images.findIndex(function (img) {
              return img.skylink.search(skylink) > -1;
            });
            if (!(foundIndex > -1)) return [3 /*break*/, 3];
            images = __spreadArrays(
